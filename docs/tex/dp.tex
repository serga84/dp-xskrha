...
\citace{apc}{Vito Chin, 2010}{\autor{Vito Chin}
\nazev{Techportal Ibuildings: Understanding APC} [online]. Dostupné z: http://techportal.ibuildings.com/2010/10/07/understanding-apc/}

\citace{memcached}{Brad Fitzpatrick, 2004}{\autor{Brad Fitzpatrick}
\nazev{Linux Journal: Distributed Caching with Memcached} [online]. Dostupné z: http://www.linuxjournal.com/article/7451}

\citace{nginx}{Will Reese, 2008}{\autor{Will Reese}
\nazev{Linux Journal: Nginx: the High-Performance Web Server and Reverse Proxy} [online]. Dostupné z: http://www.linuxjournal.com/magazine/nginx-high-performance-web-server-and-reverse-proxy}

\citace{nginx-memcached}{Ilya Grigorik, 2008}{\autor{Ilya Grigorik}
\nazev{Igvita.com: Nginx and Memcached, a 400\% boost!} [online]. Dostupné z: http://www.igvita.com/2008/02/11/nginx-and-memcached-a-400-boost/}

\citace{cdn}{Pavel Mikulka, 2008}{\autor{Bc. Pavel Mikulka}
\nazev{Implementace CDN a clusteringu v prostředí GNU/LINUX s testy výkonnosti}, Brno: VUT, 2008. 65 s. Dostupné z: http://www.vutbr.cz/www_base/zav_prace_soubor_verejne.php?file_id=7793} 

\citace{virtual}{Petr Hrůša, 2011}{\autor{Petr Hrůša}
\nazev{Výhody a nevýhody virtualizace platforem a aktuální nabídka} [online]. Dostupné z: http://www.aquasoft.eu/blog/nazor_odbornika.php?nazor=450} 
